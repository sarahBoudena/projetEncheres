...
<body>
	<div class="container-fluid">
			...
			<div class="d-flex alert-danger">
				<div class="col-3 p-2">
					<img class="small-icon"
						src="<%=request.getContextPath()%>/medias/img/erreur.png"
						alt="icone erreur">
				</div>
		...
		<form method="post"
			action="<%=request.getContextPath()%>/enchere/login">
			<div class="form-group">
				<label>identifiant : </label> <input type="text" name="email"
					value="${cookie.identite.value != null ? cookie.identite.value : ''}" />
			</div>
			<div class="form-group">
			...
			<input type="checkbox" name="memoriser"
				${cookie.identite.value != null ? "checked" : ""}> <label
				for="memoriser">Se souvenir de moi</label>
		</form>
	</div>
	<!-- fragment JSP footer -->
